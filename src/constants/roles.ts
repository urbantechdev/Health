...
export const SYSTEM_ROLES_MAP: Record<SystemRole, RoleDefinition> = {
  ...
  "Reception": {
    ...
    allowedTabs: ["reception", "queue", "journey", "tickets", "dashboard"],
    allowedModules: ["reception", "queue", "journey", "tickets", "dashboard"],
  ...
  "Doctor": {
    ...
    allowedTabs: ["doctor", "queue", "journey", "diagnostics", "pharmacy", "tickets", "dashboard"],
    allowedModules: ["doctor", "queue", "journey", "diagnostics", "pharmacy", "tickets", "dashboard"],
    department: "medical",
    colorClass: {
      bg: "bg-cyan-50",
      text: "text-cyan-900",
  ...
  "Pharmacy": {
    ...
    allowedTabs: ["pharmacy", "queue", "billing", "procurement", "dashboard"],
    allowedModules: ["pharmacy", "queue", "billing", "procurement", "dashboard"],
    department: "pharmacy",
    colorClass: {
      bg: "bg-teal-50",
      text: "text-teal-900",
  ...
  "Lab": {
    ...
    allowedTabs: ["diagnostics", "queue", "procurement", "dashboard"],
    allowedModules: ["diagnostics", "queue", "procurement", "dashboard"],
  ...
  "Billing & Accounts": {
    ...
    allowedTabs: ["billing", "finance", "queue", "dashboard"],
    allowedModules: ["billing", "finance", "queue", "dashboard"],
    department: "billing",
    colorClass: {
      bg: "bg-emerald-50",
      text: "text-emerald-900",
