  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center sm:p-4 bg-slate-950/70 backdrop-blur-xs font-sans animate-in fade-in duration-200">
      <div 
        ...
        className="bg-white border-0 sm:border sm:border-slate-200 rounded-none sm:rounded-3xl w-full max-w-4xl h-full sm:h-auto sm:max-h-[92vh] shadow-2xl flex flex-col overflow-hidden"
      >
        {/* Modal Header */}
        <div className="px-4 sm:px-6 py-3.5 sm:py-4 bg-slate-900 text-white flex items-center justify-between border-b border-slate-800 shrink-0">
          <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl sm:rounded-2xl bg-gradient-to-tr from-emerald-600 to-teal-500 flex items-center justify-center text-white shadow-md shrink-0">
              <Sparkles className="w-4 h-4 sm:w-5 sm:h-5" />
            </div>
            <div className="min-w-0">
              <h3 className="text-sm sm:text-base font-bold tracking-tight truncate">Raise & Transfer Ticket in Chat</h3>
              <p className="text-[11px] text-slate-400 truncate">
                Dispatch Invoice, Pre-Quote, Clinical Transfer, or Investigation Ticket
              </p>
            </div>
          </div>
          <button
