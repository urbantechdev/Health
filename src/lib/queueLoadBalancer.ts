...
/**
 * Standard Clinical Hospital Staff Profiles for Specialties (Kenya Level 4/5 Standard)
 * Used if staff roster is undergoing initialization or lacks specific sub-specialists.
 */
export const DEFAULT_HOSPITAL_PHYSICIANS: Employee[] = [
  {
    id: "doc-opd-001",
    name: "Dr. Kelvin Mwangi, MD",
    nationalId: "27182910",
    role: "Senior Medical Officer",
    department: "doctor",
    specialty: "General OPD / Internal Medicine",
    salary: 220000,
    phone: "+254 722 100 001",
    email: "kelvin.mwangi@hms.co.ke",
    status: "active",
    hireDate: "2023-01-10",
    systemRole: "Doctor"
  },
  {
    id: "doc-opd-002",
    name: "Dr. Sarah Kimani, MBChB",
    nationalId: "29183921",
    role: "Medical Officer",
    department: "doctor",
    specialty: "General Outpatient (OPD)",
    salary: 195000,
    phone: "+254 722 100 002",
    email: "sarah.kimani@hms.co.ke",
    status: "active",
    hireDate: "2023-06-15",
    systemRole: "Doctor"
  },
  {
    id: "doc-opd-003",
    name: "Dr. Eric Odhiambo, MBChB",
    nationalId: "28491823",
    role: "Resident Clinician",
    department: "doctor",
    specialty: "General Outpatient (OPD)",
    salary: 180000,
    phone: "+254 722 100 003",
    email: "eric.odhiambo@hms.co.ke",
    status: "active",
    hireDate: "2024-02-01",
    systemRole: "Doctor"
  },
  {
    id: "doc-cardio-001",
    name: "Dr. Grace Mutua, MMed Cardio",
    nationalId: "26481923",
  ...
  {
    id: "doc-peds-001",
    name: "Dr. Mercy Wanjiru, MMed Peds",
    nationalId: "28401928",
  ...
  {
    id: "doc-gyna-001",
    name: "Dr. Amina Hassan, MMed Obs/Gyn",
    nationalId: "26481029",
    role: "Consultant Gynecologist",
    department: "gyna",
    specialty: "Obstetrics & Gynecology (Gyna)",
    salary: 310000,
    phone: "+254 722 400 001",
    email: "amina.hassan@hms.co.ke",
    status: "active",
    hireDate: "2022-08-15",
    systemRole: "Doctor"
  },
  {
    id: "doc-gyna-002",
    name: "Dr. Fatuma Ali, MBChB",
    nationalId: "27381920",
    role: "Specialist Obstetrician",
    department: "gyna",
    specialty: "Obstetrics & Gynecology (Gyna)",
    salary: 290000,
    phone: "+254 722 400 002",
    email: "fatuma.ali@hms.co.ke",
    status: "active",
    hireDate: "2023-05-10",
    systemRole: "Doctor"
  },
  {
    id: "doc-dental-001",
    name: "Dr. Timothy Ndung'u, BDS",
    nationalId: "28491028",
    role: "Dental Surgeon",
    department: "doctor",
    specialty: "Dentistry & Dental Surgery",
    salary: 240000,
    phone: "+254 722 500 001",
    email: "timothy.ndungu@hms.co.ke",
    status: "active",
    hireDate: "2023-07-01",
    systemRole: "Doctor"
  },
  {
    id: "doc-eye-001",
    name: "Dr. Samuel Kariuki, MMed Ophth",
    nationalId: "25491029",
    role: "Consultant Ophthalmologist",
    department: "doctor",
    specialty: "Ophthalmology / Eye Surgery",
    salary: 290000,
    phone: "+254 722 600 001",
    email: "samuel.kariuki@hms.co.ke",
    status: "active",
    hireDate: "2022-10-01",
    systemRole: "Doctor"
  },
  {
    id: "doc-ortho-001",
    name: "Dr. Victor Kipkorir, FCS Ortho",
    nationalId: "24910281",
    role: "Consultant Orthopedic Surgeon",
    department: "doctor",
    specialty: "Orthopedic Surgery",
    salary: 350000,
    phone: "+254 722 700 001",
    email: "victor.kipkorir@hms.co.ke",
    status: "active",
    hireDate: "2022-03-01",
    systemRole: "Doctor"
  },
  {
    id: "doc-ent-001",
    name: "Dr. Philip Ndegwa, MMed ENT",
    nationalId: "26381920",
    role: "ENT Specialist Surgeon",
    department: "doctor",
    specialty: "Otolaryngology (ENT)",
    salary: 280000,
    phone: "+254 722 800 001",
    email: "philip.ndegwa@hms.co.ke",
    status: "active",
    hireDate: "2023-04-15",
    systemRole: "Doctor"
  }
